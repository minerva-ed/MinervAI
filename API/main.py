...
class ProfessorAgent:
    ...
    async def give_lecture(self, topic):
        if self.lecture_notes:
            ...
            return kernel.create_semantic_function(f"""Give a detailed lecture on {topic} related to {self.expertise_area}, using the following notes: {self.lecture_notes}.""", max_tokens=200)(topic)
        else:
